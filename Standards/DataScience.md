...
This standard applies to studies that primarily analyze existing **software engineering artifacts**, defined as "tangible by-products produced during the development of software"<sup>[1](#myfootnote1)</sup>.  Note that there are very kinds of such by-products including (but not limited to social metrics, descriptions of code, etc).
